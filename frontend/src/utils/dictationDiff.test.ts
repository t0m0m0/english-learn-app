...
import { compareDictation, type DictationResult, type DiffSegment } from './dictationDiff';
...
describe('compareDictation', () => {
  ...
  describe('case sensitivity', () => {
    ...
    it('should respect case when strictCase is true', () => {
      const result = compareDictation('HELLO WORLD', 'hello world', { strictCase: true });
  ...
  describe('punctuation handling', () => {
    ...
    it('should respect punctuation when strictPunctuation is true', () => {
      const result = compareDictation('Hello world', 'Hello, world!', { strictPunctuation: true });
  ...
  describe('complex cases', () => {
    ...
    it('should handle multiple errors', () => {
      ...
      expect(result.isCorrect).toBe(false);
      expect(result.diff.filter(d => d.type === 'wrong').length).toBeGreaterThan(0);
    });
